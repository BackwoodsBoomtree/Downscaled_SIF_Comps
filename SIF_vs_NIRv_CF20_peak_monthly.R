...
### Data
cs_diff   <- raster("G:/SIF_comps/min_max_diff/20km/cf20_vis/NIRv_Rad.CF20-SIF.max.clearsky.monthly.20km.2020.tif")
cf20_diff <- raster("G:/SIF_comps/min_max_diff/20km/cf20_vis/NIRv_Rad.CF20-SIF.max.CF20.monthly.20km.2020.tif")
cf40_diff <- raster("G:/SIF_comps/min_max_diff/20km/cf20_vis/NIRv_Rad.CF20-SIF.max.CF40.monthly.20km.2020.tif")
cf60_diff <- raster("G:/SIF_comps/min_max_diff/20km/cf20_vis/NIRv_Rad.CF20-SIF.max.CF60.monthly.20km.2020.tif")
cf80_diff <- raster("G:/SIF_comps/min_max_diff/20km/cf20_vis/NIRv_Rad.CF20-SIF.max.CF80.monthly.20km.2020.tif")
...
cairo_pdf("G:/SIF_comps/figs/SIF_vs_NIRv_CF20_monthly_peak_black.pdf", width=7.5, height=6)
