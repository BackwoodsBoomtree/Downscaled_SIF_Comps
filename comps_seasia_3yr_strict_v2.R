...
#### Output PDF name ####
out_name    <- "G:/SIF_comps/figs/v2/comps_seasia_map_3yr_cold_all_strict_black_v2.pdf"
data_prefix <- "G:/SIF_comps/csv/seasia/strict/SEAsia_2019-2021_strict_"
...
mcd12_majority <- crop(mcd12_majority, seasia_ext)
...
# Map
plot(coastlines, border = NA, col = rgb(0.30,0.30,0.30), xlim = c(72, 180), ylim = c(-23.5, 23.5), mar = c(0,6,0,0.5))
plot(mcd12_majority, col = map.cols, add = TRUE, legend = FALSE)
mtext(3, text = "Asia-Pacific Tropical Forest", col = "white")
box(col = "white")
# Legend
