...
out_name   <- "G:/SIF_comps/figs/v2/hotspot_tropics_black_v2.pdf"
...
samerica_m_equ_red_fit <- lm(samerica_m_equ_norm$red ~ samerica_m_equ_no_outliers$pa + I(samerica_m_equ_no_outliers$pa^2))
samerica_m_equ_nir_fit <- lm(samerica_m_equ_norm$nir ~ samerica_m_equ_no_outliers$pa + I(samerica_m_equ_no_outliers$pa^2))
...
africa_m_equ_red_fit <- lm(africa_m_equ_norm$red ~ africa_m_equ_no_outliers$pa + I(africa_m_equ_no_outliers$pa^2))
africa_m_equ_nir_fit <- lm(africa_m_equ_norm$nir ~ africa_m_equ_no_outliers$pa + I(africa_m_equ_no_outliers$pa^2))
...
seasia_m_equ_red_fit <- lm(seasia_m_equ_norm$red ~ seasia_m_equ_no_outliers$pa + I(seasia_m_equ_no_outliers$pa^2))
seasia_m_equ_nir_fit <- lm(seasia_m_equ_norm$nir ~ seasia_m_equ_no_outliers$pa + I(seasia_m_equ_no_outliers$pa^2))
...
samerica_s_equ_red_fit <- lm(samerica_s_equ_norm$red ~ samerica_s_equ_no_outliers$pa + I(samerica_s_equ_no_outliers$pa^2))
samerica_s_equ_nir_fit <- lm(samerica_s_equ_norm$nir ~ samerica_s_equ_no_outliers$pa + I(samerica_s_equ_no_outliers$pa^2))
...
africa_s_equ_red_fit <- lm(africa_s_equ_norm$red ~ africa_s_equ_no_outliers$pa + I(africa_s_equ_no_outliers$pa^2))
africa_s_equ_nir_fit <- lm(africa_s_equ_norm$nir ~ africa_s_equ_no_outliers$pa + I(africa_s_equ_no_outliers$pa^2))
...
seasia_s_equ_red_fit <- lm(seasia_s_equ_norm$red ~ seasia_s_equ_no_outliers$pa + I(seasia_s_equ_no_outliers$pa^2))
seasia_s_equ_nir_fit <- lm(seasia_s_equ_norm$nir ~ seasia_s_equ_no_outliers$pa + I(seasia_s_equ_no_outliers$pa^2))
