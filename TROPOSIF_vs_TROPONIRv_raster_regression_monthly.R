...
sif_file   <- "G:/TROPOMI/esa/gridded/20km/monthly/2020/TROPOMI.ESA.SIF.2020.global.monthly.20km.CF40.nc"
y_name     <- "SIF_743"
x_name     <- "NIRv_RAD"
out_dir    <- "G:/SIF_comps/nirv_rad/2020/monthly/20km/clearsky_nirvr/raster_regressions"
out_name   <- "TROPOSIF.CF40_vs_TROPONIRv_RAD.clearsky.monthly.20km.2020"
