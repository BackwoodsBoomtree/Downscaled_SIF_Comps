...
#### Output PDF name ####
out_name   <- "G:/SIF_comps/figs/error_seasia.pdf"
...
seasia_sif_cs_all      <- get_ts("SIF_743", "n", "SIF_743_std", c(cs_all_2019, cs_all_2020, cs_all_2021), seasia_ext, mask_total)[[2]]
seasia_nirv_cs_all     <- get_ts("NIRv", "n", "NIRv_std", c(cs_all_2019, cs_all_2020, cs_all_2021), seasia_ext, mask_total)[[2]]
seasia_nirv_rad_cs_all <- get_ts("NIRv_Rad", "n", "NIRv_Rad_std", c(cs_all_2019, cs_all_2020, cs_all_2021), seasia_ext, mask_total)[[2]]
seasia_ref_665_cs_all  <- get_ts("REF_665", "n", "REF_665_std", c(cs_all_2019, cs_all_2020, cs_all_2021), seasia_ext, mask_total)[[2]]
seasia_ref_781_cs_all  <- get_ts("REF_781", "n", "REF_781_std", c(cs_all_2019, cs_all_2020, cs_all_2021), seasia_ext, mask_total)[[2]]

seasia_sif_cs      <- get_ts("SIF_743", "n", "SIF_743_std", c(cs_2019, cs_2020, cs_2021), seasia_ext, mask_total)[[2]]
seasia_nirv_cs     <- get_ts("NIRv", "n", "NIRv_std", c(cs_2019, cs_2020, cs_2021), seasia_ext, mask_total)[[2]]
seasia_nirv_rad_cs <- get_ts("NIRv_Rad", "n", "NIRv_Rad_std", c(cs_2019, cs_2020, cs_2021), seasia_ext, mask_total)[[2]]
seasia_ref_665_cs  <- get_ts("REF_665", "n", "REF_665_std", c(cs_2019, cs_2020, cs_2021), seasia_ext, mask_total)[[2]]
seasia_ref_781_cs  <- get_ts("REF_781", "n", "REF_781_std", c(cs_2019, cs_2020, cs_2021), seasia_ext, mask_total)[[2]]

seasia_sif_cf      <- get_ts("SIF_743", "n", "SIF_743_std", c(cf_2019, cf_2020, cf_2021), seasia_ext, mask_total)[[2]]
seasia_nirv_cf     <- get_ts("NIRv", "n", "NIRv_std", c(cf_2019, cf_2020, cf_2021), seasia_ext, mask_total)[[2]]
seasia_nirv_rad_cf <- get_ts("NIRv_Rad", "n", "NIRv_Rad_std", c(cf_2019, cf_2020, cf_2021), seasia_ext, mask_total)[[2]]
seasia_ref_665_cf  <- get_ts("REF_665", "n", "REF_665_std", c(cf_2019, cf_2020, cf_2021), seasia_ext, mask_total)[[2]]
seasia_ref_781_cf  <- get_ts("REF_781", "n", "REF_781_std", c(cf_2019, cf_2020, cf_2021), seasia_ext, mask_total)[[2]]
...
hist(seasia_sif_cs_all, axes = FALSE, xlab = "", ylab = "", main = NA)
...
hist(seasia_sif_cs, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()
...
hist(seasia_sif_cf, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()
...
# nirv
hist(seasia_nirv_cs_all, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()
mtext(2, text = "Frequency", line = 1.5)

hist(seasia_nirv_cs, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
mtext(1, text = lab_nirv, line = 2)
box()

hist(seasia_nirv_cf, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()

# nirv rad
hist(seasia_nirv_rad_cs_all, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()
mtext(2, text = "Frequency", line = 1.5)

hist(seasia_nirv_rad_cs, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
mtext(1, text = lab_nirvr, line = 2)
box()

hist(seasia_nirv_rad_cf, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()

# red ref
hist(seasia_ref_665_cs_all, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()
mtext(2, text = "Frequency", line = 1.5)

hist(seasia_ref_665_cs, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
mtext(1, text = lab_665, line = 2)
box()

hist(seasia_ref_665_cf, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()

# red ref
hist(seasia_ref_781_cs_all, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()
mtext(2, text = "Frequency", line = 1.5)

hist(seasia_ref_781_cs, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
mtext(1, text = lab_781, line = 2)
box()

hist(seasia_ref_781_cf, axes = FALSE, xlab = "", ylab = "", main = NA)
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
box()

mtext(3, text = "Monthly Standard Error of the Mean for SE Asian Tropical Forest", outer = TRUE, line = -1.5)
