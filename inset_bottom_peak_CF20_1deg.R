...
# Data #
cf20_diff <- raster("G:/SIF_comps/min_max_diff/1deg/cf20/NIRv_Rad.cf20-SIF.max.cf20.monthly.1deg.2021.tif")
...
cairo_pdf("G:/SIF_comps/figs/inset_bottom_peak_CF20_1deg_black.pdf", width = 7.5, height = 2.5)
