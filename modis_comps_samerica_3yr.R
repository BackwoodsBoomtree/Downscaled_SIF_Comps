...
#### Output PDF name ####
out_name   <- "G:/SIF_comps/figs/modis_comps_samerica_3yr_black.pdf"
...
cover        <- crop(mask_total, samerica_ext)

ts_mod_red_2019 <- crop(mask(rast(mod_red_2019, subds = "RED"), mask_total), samerica_ext)
...
ts_sif_cs_all      <- min_max_norm(get_ts("SIF_743", "n", "SIF_743_std", c(cs_all_2019, cs_all_2020, cs_all_2021), samerica_ext, mask_total)[[1]])
ts_nirv_cs_all     <- min_max_norm(get_ts("NIRv", "n", "NIRv_std", c(cs_all_2019, cs_all_2020, cs_all_2021), samerica_ext, mask_total)[[1]])
ts_nirv_rad_cs_all <- min_max_norm(get_ts("NIRv_Rad", "n", "NIRv_Rad_std", c(cs_all_2019, cs_all_2020, cs_all_2021), samerica_ext, mask_total)[[1]])
ts_ref_665_cs_all  <- min_max_norm(get_ts("REF_665", "n", "REF_665_std", c(cs_all_2019, cs_all_2020, cs_all_2021), samerica_ext, mask_total)[[1]])
ts_ref_781_cs_all  <- min_max_norm(get_ts("REF_781", "n", "REF_781_std", c(cs_all_2019, cs_all_2020, cs_all_2021), samerica_ext, mask_total)[[1]])

ts_sif_cs      <- min_max_norm(get_ts("SIF_743", "n", "SIF_743_std", c(cs_2019, cs_2020, cs_2021), samerica_ext, mask_total)[[1]])
ts_nirv_cs     <- min_max_norm(get_ts("NIRv", "n", "NIRv_std", c(cs_2019, cs_2020, cs_2021), samerica_ext, mask_total)[[1]])
ts_nirv_rad_cs <- min_max_norm(get_ts("NIRv_Rad", "n", "NIRv_Rad_std", c(cs_2019, cs_2020, cs_2021), samerica_ext, mask_total)[[1]])
ts_ref_665_cs  <- min_max_norm(get_ts("REF_665", "n", "REF_665_std", c(cs_2019, cs_2020, cs_2021), samerica_ext, mask_total)[[1]])
ts_ref_781_cs  <- min_max_norm(get_ts("REF_781", "n", "REF_781_std", c(cs_2019, cs_2020, cs_2021), samerica_ext, mask_total)[[1]])

# Get timeseries MOD data
ts_mod_red  <- min_max_norm(get_ts_mod("RED", c(mod_red_2019, mod_red_2020, mod_red_2021), samerica_ext, mask_total)/1000)
ts_mod_nir  <- min_max_norm(get_ts_mod("NIR", c(mod_nir_2019, mod_nir_2020, mod_nir_2021), samerica_ext, mask_total)/10000)
ts_mod_nirv <- min_max_norm(get_ts_mod("NIRv", c(mod_nirv_2019, mod_nirv_2020, mod_nirv_2021), samerica_ext, mask_total)/10000)
...
mtext(3, text = "South America Tropical Forest", col = "white", outer = TRUE)
