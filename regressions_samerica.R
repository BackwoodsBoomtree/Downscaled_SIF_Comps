...
#### Output PDF name ####
out_name   <- "G:/SIF_comps/figs/regressions_samerica.pdf"
...
# Labels
lab_title  <- "South American Tropical Forest"
...
axis(1, tck = 0.03, mgp=c(3, 0.2, 0))
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), las = 2)
legend("topright", bty = "n", legend = c(as.expression(reg_ref_781_cs_r), as.expression(reg_ref_781_cs_p)))
