...
#### Output PDF name ####
out_name    <- "G:/SIF_comps/figs/v2/comps_samerica_map_3yr_cold_all_strict_extra_black_v2.pdf"
data_prefix <- "G:/SIF_comps/csv/amazon/monthly/strict_extra/Amazon_2019-2021_strict_extra_"
