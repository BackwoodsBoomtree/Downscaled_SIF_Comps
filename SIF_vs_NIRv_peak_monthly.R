...
cf20_r2 <- raster("G:/SIF_comps/nirv_rad/2020/monthly/20km/cf20/raster_regressions/TROPOSIF_vs_TROPONIRv_RAD.monthly.20km.CF20.2020_Rsquare.tif")
cf80_r2 <- raster("G:/SIF_comps/nirv_rad/2020/monthly/20km/cf2080/raster_regressions/TROPOSIF_vs_TROPONIRv_RAD.monthly.20km.CF2080.2020_Rsquare.tif")

cs_pval   <- raster("G:/SIF_comps/nirv_rad/2020/monthly/20km/clearsky/raster_regressions/TROPOSIF_vs_TROPONIRv_RAD.monthly.20km.clearsky.2020_Pval.tif")
cf20_pval <- raster("G:/SIF_comps/nirv_rad/2020/monthly/20km/cf20/raster_regressions/TROPOSIF_vs_TROPONIRv_RAD.monthly.20km.CF20.2020_Pval.tif")
cf80_pval <- raster("G:/SIF_comps/nirv_rad/2020/monthly/20km/cf2080/raster_regressions/TROPOSIF_vs_TROPONIRv_RAD.monthly.20km.CF2080.2020_Pval.tif")

cs_diff   <- raster("G:/SIF_comps/min_max_diff/20km/clearsky/NIRv_Rad-SIF.max.monthly.20km.clearsky.2020.tif")
cf20_diff <- raster("G:/SIF_comps/min_max_diff/20km/cf20/NIRv_Rad-SIF.max.monthly.20km.CF20.2020.tif")
...
labs <- c(paste0("Monthly SIF vs NIRv: Clear Sky"),
          ...
          paste0("Monthly SIF vs NIRv: Cloud Fraction ", intToUtf8(8804)," 0.20"),
          paste0("Peak NIRv - Peak SIF: Cloud Fraction ", intToUtf8(8804)," 0.20"),
          paste0("Monthly SIF vs NIRv: Cloud Fraction ", intToUtf8(8804), " 0.80 & ", intToUtf8(8804)," 0.20"),
          paste0("Peak NIRv - Peak SIF: Cloud Fraction ", intToUtf8(8804), " 0.80 & ", intToUtf8(8804)," 0.20"))

##### PLOTS ####

cairo_pdf("G:/SIF_comps/figs/SIF_vs_NIRv_monthly_black.pdf", width=7.5, height=6)
