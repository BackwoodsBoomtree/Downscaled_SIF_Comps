...
out_name    <- "G:/SIF_comps/figs/v2/sif_comps_single_white_timeseries_v2.pdf"
...
tropo_sif_mean <- c(rep(NA, 96), tropo_sif_data$Mean)
oco2_sif_mean  <- c(rep(NA, 48), oco2_sif_data$Mean)
oco3_sif_mean  <- c(rep(NA, 96), oco3_sif_data$Mean)
...
lines(gome2_sif_mean, col = sifg.col, type = "o", lwd = 1, pch = 17, cex = 0.75, lty = 1)
lines(tropo_sif_mean, col = sift.col, type = "o", lwd = 1, pch = 16, cex = 0.75, lty = 1)
lines(oco2_sif_mean, col = sifo2.col, type = "o", lwd = 1, pch = 15, cex = 0.75, lty = 1)
lines(oco3_sif_mean, col = sifo3.col, type = "o", lwd = 1, pch = 18, cex = 0.75, lty = 1)
