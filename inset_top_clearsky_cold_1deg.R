...
# Data #
cf20_diff_max <- raster("G:/SIF_comps/min_max_diff/1deg/clearsky/NIRv_Rad.clearsky-SIF.max.clearsky.cold.monthly.1deg.2021.tif")
cf20_diff_min <- raster("G:/SIF_comps/min_max_diff/1deg/clearsky/NIRv_Rad.clearsky-SIF.min.clearsky.cold.monthly.1deg.2021.tif")
...
# Colors
diff_max.col <- coolwarm(13)
diff_min.col <- coolwarm(13)
...
cairo_pdf("G:/SIF_comps/figs/inset_top_clearsky_cold_1deg_black.pdf", width = 7.5, height = 2.25)
