...
out_name   <- "G:/SIF_comps/figs/relative_sif_all_black.pdf"
...
par(mfrow = c(3, 3), oma=c(3.0,5.75,0,0.1), bg = "black")

# samerica SIF Relative
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, samerica_ts_sif_rel_cs, col = mag.cols[4], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.010, 0.022))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, samerica_ts_sif_rel_cs, col = mag.cols[4], lwd = 1.5)
lines(x, samerica_ts_sif_rel_cf, col = mag.cols[4], lwd = 1.5, lty = 2)
lines(x, samerica_ts_sif_rel_cs_all, col = mag.cols[4], lwd = 1.5, lty = 3)
...
mtext(2, text = do.call(expression, y_lab_sif), col = "white", line = c(4.75, 2.75))
mtext(3, text = "S America Tropical Forest", col = "white", line = 0.5)
box(col = "white")

# africa SIF Relative
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, africa_ts_sif_rel_cs, col = mag.cols[4], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.010, 0.022))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, africa_ts_sif_rel_cs, col = mag.cols[4], lwd = 1.5)
lines(x, africa_ts_sif_rel_cf, col = mag.cols[4], lwd = 1.5, lty = 2)
lines(x, africa_ts_sif_rel_cs_all, col = mag.cols[4], lwd = 1.5, lty = 3)
axis(1, tck = 0.03, labels = FALSE, at = x, col.axis = "white", col = "white")
axis(1, tck = 0.06, labels = FALSE, at = seq(1, 36, by = 3), col.axis = "white", col = "white")
...
# seasia SIF Relative
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, seasia_ts_sif_rel_cs, col = mag.cols[4], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.010, 0.022))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, seasia_ts_sif_rel_cs, col = mag.cols[4], lwd = 1.5)
lines(x, seasia_ts_sif_rel_cf, col = mag.cols[4], lwd = 1.5, lty = 2)
lines(x, seasia_ts_sif_rel_cs_all, col = mag.cols[4], lwd = 1.5, lty = 3)
axis(1, tck = 0.03, labels = FALSE, at = x, col.axis = "white", col = "white")
axis(1, tck = 0.06, labels = FALSE, at = seq(1, 36, by = 3), col.axis = "white", col = "white")
axis(2, tck = 0.03, labels = FALSE, col.axis = "white", col = "white", las = 2)
# mtext(2, text = do.call(expression, y_lab_sif), col = "white", line = c(4.75, 2.75))
...
# samerica NIRv Relative
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, samerica_ts_nirv_rel_cs, col = mag.cols[5], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.0010, 0.0025))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, samerica_ts_nirv_rel_cs, col = mag.cols[5], lwd = 1.5)
lines(x, samerica_ts_nirv_rel_cf, col = mag.cols[5], lwd = 1.5, lty = 2)
lines(x, samerica_ts_nirv_rel_cs_all, col = mag.cols[5], lwd = 1.5, lty = 3)
axis(1, tck = 0.03, labels = FALSE, at = x, col.axis = "white", col = "white")
axis(1, tck = 0.06, labels = FALSE, at = seq(1, 36, by = 3), col.axis = "white", col = "white")
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), col.axis = "white", col = "white", las = 2)
mtext(2, text = do.call(expression, y_lab_nirv), col = "white", line = c(4.75, 2.75))
box(col = "white")

# africa NIRv Relative
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, africa_ts_nirv_rel_cs, col = mag.cols[5], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.0010, 0.0025))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, africa_ts_nirv_rel_cs, col = mag.cols[5], lwd = 1.5)
lines(x, africa_ts_nirv_rel_cf, col = mag.cols[5], lwd = 1.5, lty = 2)
lines(x, africa_ts_nirv_rel_cs_all, col = mag.cols[5], lwd = 1.5, lty = 3)
axis(1, tck = 0.03, labels = FALSE, at = x, col.axis = "white", col = "white")
axis(1, tck = 0.06, labels = FALSE, at = seq(1, 36, by = 3), col.axis = "white", col = "white")
axis(2, tck = 0.03, labels = FALSE, col.axis = "white", col = "white", las = 2)
# mtext(2, text = do.call(expression, y_lab_nirv), col = "white", line = c(4.75, 2.75))
...
# seasia NIRv Relative
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, seasia_ts_nirv_rel_cs, col = mag.cols[5], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.0010, 0.0025))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, seasia_ts_nirv_rel_cs, col = mag.cols[5], lwd = 1.5)
lines(x, seasia_ts_nirv_rel_cf, col = mag.cols[5], lwd = 1.5, lty = 2)
lines(x, seasia_ts_nirv_rel_cs_all, col = mag.cols[5], lwd = 1.5, lty = 3)
axis(1, tck = 0.03, labels = FALSE, at = x, col.axis = "white", col = "white")
axis(1, tck = 0.06, labels = FALSE, at = seq(1, 36, by = 3), col.axis = "white", col = "white")
axis(2, tck = 0.03, labels = FALSE, col.axis = "white", col = "white", las = 2)
# mtext(2, text = do.call(expression, y_lab_nirv), col = "white", line = c(4.75, 2.75))
...
# samerica Yelu
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, samerica_ts_yelu_cs, col = mag.cols[6], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.022, 0.038))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, samerica_ts_yelu_cs, col = mag.cols[6], lwd = 1.5)
lines(x, samerica_ts_yelu_cf, col = mag.cols[6], lwd = 1.5, lty = 2)
lines(x, samerica_ts_yelu_cs_all, col = mag.cols[6], lwd = 1.5, lty = 3)
axis(1, tck = 0.03, labels = FALSE, at = x, col.axis = "white", col = "white")
axis(1, tck = 0.06, mgp=c(3, 0.2, 0), labels = xlabs, at = seq(1, 36, by = 3), col.axis = "white", col = "white")
axis(2, tck = 0.03, mgp=c(3, 0.2, 0), col.axis = "white", col = "white", las = 2)
mtext(2, text = do.call(expression, y_lab_yelu), col = "white", line = c(4.75, 2.75))
box(col = "white")

# africa Yelu
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, africa_ts_yelu_cs, col = mag.cols[6], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.022, 0.038))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, africa_ts_yelu_cs, col = mag.cols[6], lwd = 1.5)
lines(x, africa_ts_yelu_cf, col = mag.cols[6], lwd = 1.5, lty = 2)
lines(x, africa_ts_yelu_cs_all, col = mag.cols[6], lwd = 1.5, lty = 3)
axis(1, tck = 0.03, labels = FALSE, at = x, col.axis = "white", col = "white")
axis(1, tck = 0.06, mgp=c(3, 0.2, 0), labels = xlabs, at = seq(1, 36, by = 3), col.axis = "white", col = "white")
axis(2, tck = 0.03, labels = FALSE, col.axis = "white", col = "white", las = 2)
# mtext(2, text = do.call(expression, y_lab_yelu), col = "white", line = c(4.75, 2.75))
...
# seasia Yelu
op <- par(mar = c(0,0.5,2,0.5), bg = "black")
plot(x, seasia_ts_yelu_cs, col = mag.cols[6], type = "l", axes = FALSE, lwd = 1.5, xaxs="i",
     ylim = c(0.022, 0.038))
rect(13, 0, 24, 100, col = rgb(0.30,0.30,0.30), border = NA)
lines(x, seasia_ts_yelu_cs, col = mag.cols[6], lwd = 1.5)
lines(x, seasia_ts_yelu_cf, col = mag.cols[6], lwd = 1.5, lty = 2)
lines(x, seasia_ts_yelu_cs_all, col = mag.cols[6], lwd = 1.5, lty = 3)
axis(1, tck = 0.03, labels = FALSE, at = x, col.axis = "white", col = "white")
axis(1, tck = 0.06, mgp=c(3, 0.2, 0), labels = xlabs, at = seq(1, 36, by = 3), col.axis = "white", col = "white")
axis(2, tck = 0.03, labels = FALSE, col.axis = "white", col = "white", las = 2)
# mtext(2, text = do.call(expression, y_lab_yelu), col = "white", line = c(4.75, 2.75))
