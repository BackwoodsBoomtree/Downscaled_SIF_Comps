...
out_name     <- "clearsky.monthly.20km.2020"

tropomi_sif_max   <- rast("G:/SIF_comps/min_max/20km/clearsky/SIF.max.monthly.20km.clearsky.2020.tif")
tropomi_sif_min   <- rast("G:/SIF_comps/min_max/20km/clearsky/SIF.min.monthly.20km.clearsky.2020.tif")
