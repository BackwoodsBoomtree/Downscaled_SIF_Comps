...
out_name   <- "G:/SIF_comps/figs/comps_tropics_map_3yr_cold_all_trend_black.pdf"
...
lines(predict(lm(ts_sif_cs_all ~ x)),col='red', lwd = 2)

test_sif <- MannKendall(ts_sif_cs_all)
SeasonalMannKendall(ts(ts_sif_cs_all))

legend("topright", legend = c(paste0("tau = ", round(test_sif$tau[[1]], 3)), paste0("2-sided p-value = ", round(test_sif$sl[[1]], 3))), text.col = "white",
       cex = 0.75, box.col = "white")
...
lines(predict(lm(ts_ref_781_cs_all ~ x)),col='red', lwd = 2)

test_nir <- MannKendall(ts_ref_781_cs_all)
SeasonalMannKendall(ts(ts_ref_781_cs_all))

legend("topright", legend = c(paste0("tau = ", round(test_nir$tau[[1]], 3)), paste0("2-sided p-value = ", round(test_nir$sl[[1]], 3))), text.col = "white",
       cex = 0.75, box.col = "white")
...
lines(predict(lm(ts_nirv_cs_all ~ x)),col='red', lwd = 2)

test_nirv <- MannKendall(ts_nirv_cs_all)
SeasonalMannKendall(ts(ts_nirv_cs_all))

legend("topright", legend = c(paste0("tau = ", round(test_nirv$tau[[1]], 3)), paste0("2-sided p-value = ", round(test_nirv$sl[[1]], 3))), text.col = "white",
       cex = 0.75, box.col = "white")
...
lines(predict(lm(ts_ref_665_cs_all ~ x)),col='red', lwd = 2)

test_red <- MannKendall(ts_ref_665_cs_all)
SeasonalMannKendall(ts(ts_ref_665_cs_all))

legend("topright", legend = c(paste0("tau = ", round(test_red$tau[[1]], 3)), paste0("2-sided p-value = ", round(test_red$sl[[1]], 3))), text.col = "white",
       cex = 0.75, box.col = "white")
...
lines(predict(lm(ts_nirv_rad_cs_all ~ x)), col='red', lwd = 2)

test_nirvr <- MannKendall(ts_nirv_rad_cs_all)
SeasonalMannKendall(ts(ts_nirv_rad_cs_all))

legend("topright", legend = c(paste0("tau = ", round(test_nirvr$tau[[1]], 3)), paste0("2-sided p-value = ", round(test_nirvr$sl[[1]], 3))), text.col = "white",
       cex = 0.75, box.col = "white")
